...
import top.yztz.gingerbulkmessenger.data.HistoryManager;
import top.yztz.gingerbulkmessenger.data.SettingManager;
import top.yztz.gingerbulkmessenger.data.Settings;
import top.yztz.gingerbulkmessenger.fragments.HomeFrag;
import top.yztz.gingerbulkmessenger.fragments.SettingFrag;
import top.yztz.gingerbulkmessenger.services.SMSSender;
import top.yztz.gingerbulkmessenger.util.FileUtil;
import top.yztz.gingerbulkmessenger.util.LocaleUtils;
import top.yztz.gingerbulkmessenger.util.ToastUtil;
import top.yztz.gingerbulkmessenger.util.XiaomiUtil;

import static top.yztz.gingerbulkmessenger.util.FileUtil.getFilePathFromContentUri;
...
import top.yztz.gingerbulkmessenger.util.MarkwonFactory;
    ...
    public void loadData(String path) {
        ...
        new Thread(() -> {
            ...
            try {
                DataModel.load(path);
                isSuccess = true;
            } catch (top.yztz.gingerbulkmessenger.exception.DataLoadFailed e) {
